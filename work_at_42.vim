...
silent! normal! zE
let s:l = 232 - ((28 * winheight(0) + 18) / 36)
...
wincmd w
argglobal
if bufexists("~/Desktop/FT_42/Cercle_4/CUB3D/srcs/utils/key_hooks.c") | buffer ~/Desktop/FT_42/Cercle_4/CUB3D/srcs/utils/key_hooks.c | else | edit ~/Desktop/FT_42/Cercle_4/CUB3D/srcs/utils/key_hooks.c | endif
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal backupcopy=
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 55 - ((0 * winheight(0) + 17) / 35)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
55
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 204 - ((34 * winheight(0) + 36) / 72)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
204
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 112 - ((34 * winheight(0) + 17) / 35)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
112
...
badd +310 ~/Desktop/FT_42/Cercle_4/CUB3D/srcs/utils/key_hooks.c
