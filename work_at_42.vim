...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 94 - ((27 * winheight(0) + 17) / 35)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
94
...
wincmd w
argglobal
if bufexists("~/Desktop/FT_42/Cercle_4/CUB3D/sound") | buffer ~/Desktop/FT_42/Cercle_4/CUB3D/sound | else | edit ~/Desktop/FT_42/Cercle_4/CUB3D/sound | endif
let s:cpo_save=&cpo
set cpo&vim
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 369 - ((13 * winheight(0) + 17) / 35)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
369
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 114 - ((22 * winheight(0) + 36) / 72)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
114
...
badd +128 ~/Desktop/FT_42/Cercle_4/CUB3D/srcs/main.c
