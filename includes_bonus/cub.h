...
/* -------------------------------------------------------------------------- */
/*               FILE = srcs_bonus/utils/singletons/singleton.c               */
/* -------------------------------------------------------------------------- */
t_data			*_img(void);
t_mlx			*_mlx(void);
t_media			*_media(void);
...
/* -------------------------------------------------------------------------- */
/*              FILE = srcs_bonus/utils/singletons/singleton_2.c              */
/* -------------------------------------------------------------------------- */
t_obj			*_player2(void);
...
/* -------------------------------------------------------------------------- */
/*              FILE = srcs_bonus/utils/singletons/singleton_3.c              */
/* -------------------------------------------------------------------------- */
t_var			*_var(void);
t_log			*_log(void);
t_image			*_image(void);
...
/* -------------------------------------------------------------------------- */
/*                 FILE = srcs_bonus/utils/garbage/garbage.c                  */
/* -------------------------------------------------------------------------- */
...
/* -------------------------------------------------------------------------- */
/*                FILE = srcs_bonus/utils/garbage/garbage_2.c                 */
/* -------------------------------------------------------------------------- */
t_list			*_lstimg(void);
...
/* -------------------------------------------------------------------------- */
/*                FILE = srcs_bonus/utils/garbage/garbage_3.c                 */
/* -------------------------------------------------------------------------- */
...
/* -------------------------------------------------------------------------- */
/*             FILE = srcs_bonus/utils/collisions/collisions_3.c              */
/* -------------------------------------------------------------------------- */
void			*detect_neighbors(void);
int				is_neighbor(t_vector2D pos);

/* -------------------------------------------------------------------------- */
/*             FILE = srcs_bonus/utils/collisions/collisions_2.c              */
/* -------------------------------------------------------------------------- */
...
/* -------------------------------------------------------------------------- */
/*              FILE = srcs_bonus/utils/collisions/collisions.c               */
/* -------------------------------------------------------------------------- */
...
/* -------------------------------------------------------------------------- */
/*                  FILE = srcs_bonus/utils/sounds/sound_2.c                  */
/* -------------------------------------------------------------------------- */
...
/* -------------------------------------------------------------------------- */
/*                  FILE = srcs_bonus/utils/sounds/sound_3.c                  */
/* -------------------------------------------------------------------------- */
...
/* -------------------------------------------------------------------------- */
/*                   FILE = srcs_bonus/utils/sounds/sound.c                   */
/* -------------------------------------------------------------------------- */
...
/* -------------------------------------------------------------------------- */
/*                  FILE = srcs_bonus/utils/sounds/sound_4.c                  */
/* -------------------------------------------------------------------------- */
...
/* -------------------------------------------------------------------------- */
/*                     FILE = srcs_bonus/utils/restart.c                      */
/* -------------------------------------------------------------------------- */
void			replace_player(void);
void			restart_player(void);

/* -------------------------------------------------------------------------- */
/*                      FILE = srcs_bonus/utils/clock.c                       */
/* -------------------------------------------------------------------------- */
...
/* -------------------------------------------------------------------------- */
/*                FILE = srcs_bonus/utils/hooks/movements_2.c                 */
/* -------------------------------------------------------------------------- */
...
/* -------------------------------------------------------------------------- */
/*                   FILE = srcs_bonus/utils/hooks/escape.c                   */
/* -------------------------------------------------------------------------- */
...
/* -------------------------------------------------------------------------- */
/*                 FILE = srcs_bonus/utils/hooks/key_hooks.c                  */
/* -------------------------------------------------------------------------- */
...
/* -------------------------------------------------------------------------- */
/*                 FILE = srcs_bonus/utils/hooks/movements.c                  */
/* -------------------------------------------------------------------------- */
...
/* -------------------------------------------------------------------------- */
/*                FILE = srcs_bonus/utils/hooks/key_hooks_2.c                 */
/* -------------------------------------------------------------------------- */
void			weapons(void);
...
/* -------------------------------------------------------------------------- */
/*                FILE = srcs_bonus/utils/malloc_hooks_enum.c                 */
/* -------------------------------------------------------------------------- */

/* -------------------------------------------------------------------------- */
/*              FILE = srcs_bonus/raycasting/raycasting_utils.c               */
/* -------------------------------------------------------------------------- */
int				intersects(t_circle circle, t_rect rect);
void			ft_put_pixel(t_data *a, t_data *b, t_vector2D pos_a,
					t_vector2D pos_b);
void			ft_put_pixel_color(t_data *a, char color[4], int x, int y);
void			ft_put_pixel_color_unsigned(t_data *a, unsigned char c[4],
					int x, int y);
void			draw_rays(void);
...
/* -------------------------------------------------------------------------- */
/*               FILE = srcs_bonus/raycasting/player_casting.c                */
/* -------------------------------------------------------------------------- */
void			sort_by_distance(t_obj *player);
void			player_casting(void);

/* -------------------------------------------------------------------------- */
/*              FILE = srcs_bonus/raycasting/player_casting_3.c               */
/* -------------------------------------------------------------------------- */
...
/* -------------------------------------------------------------------------- */
/*                 FILE = srcs_bonus/raycasting/raycasting.c                  */
/* -------------------------------------------------------------------------- */
...
/* -------------------------------------------------------------------------- */
/*               FILE = srcs_bonus/raycasting/bullet_casting.c                */
/* -------------------------------------------------------------------------- */
...
/* -------------------------------------------------------------------------- */
/*                FILE = srcs_bonus/raycasting/spritecasting.c                */
/* -------------------------------------------------------------------------- */
void			sprite_casting(void);

/* -------------------------------------------------------------------------- */
/*                FILE = srcs_bonus/raycasting/name_casting.c                 */
/* -------------------------------------------------------------------------- */
void			name_casting(void);

/* -------------------------------------------------------------------------- */
/*                        FILE = srcs_bonus/kill_log.c                        */
/* -------------------------------------------------------------------------- */
t_elem			*new_log(int id1, int id2);
void			print_log(t_list	*li);

/* -------------------------------------------------------------------------- */
/*              FILE = srcs_bonus/network_client/network_utils.c              */
/* -------------------------------------------------------------------------- */
...
/* -------------------------------------------------------------------------- */
/*                FILE = srcs_bonus/network_client/client_4.c                 */
/* -------------------------------------------------------------------------- */
char			*ft_get_ip_input(void);
int				ft_init_client_first(void);

/* -------------------------------------------------------------------------- */
/*                FILE = srcs_bonus/network_client/client_2.c                 */
/* -------------------------------------------------------------------------- */
...
/* -------------------------------------------------------------------------- */
/*                      FILE = srcs_bonus/network/recv.c                      */
/* -------------------------------------------------------------------------- */
void			ft_help_first_recv(t_client_thread *client,
...
/* -------------------------------------------------------------------------- */
/*                    FILE = srcs_bonus/network/round_2.c                     */
/* -------------------------------------------------------------------------- */
int				round_play(int round, t_send_server_game *data,
					t_client_thread *c, int f);
...
/* -------------------------------------------------------------------------- */
/*                     FILE = srcs_bonus/network/lobby.c                      */
/* -------------------------------------------------------------------------- */
...
/* -------------------------------------------------------------------------- */
/*                    FILE = srcs_bonus/network/round_1.c                     */
/* -------------------------------------------------------------------------- */
int				round_end_wait(t_send_server_game *data,
					t_client_thread *client);
int				ft_if_wait(t_client_thread *client);
int				round_wait_start(t_send_server_game *data,
					t_client_thread *client);
int				round_start(int *round, t_send_server_game *data,
					t_client_thread *client);
void			round_leaderboard(t_send_server_game *data,
					t_client_thread *client);

/* -------------------------------------------------------------------------- */
/*                      FILE = srcs_bonus/network/send.c                      */
/* -------------------------------------------------------------------------- */
int				ft_send_all_data(t_client_thread *client);
int				send_nb_players(t_client_thread *client);

/* -------------------------------------------------------------------------- */
/*                     FILE = srcs_bonus/network/server.c                     */
/* -------------------------------------------------------------------------- */
...
/* -------------------------------------------------------------------------- */
/*                 FILE = srcs_bonus/network/server_thread.c                  */
/* -------------------------------------------------------------------------- */
...
/* -------------------------------------------------------------------------- */
/*                      FILE = srcs_bonus/network/init.c                      */
/* -------------------------------------------------------------------------- */
...
/* -------------------------------------------------------------------------- */
/*                    FILE = srcs_bonus/network/lobby_2.c                     */
/* -------------------------------------------------------------------------- */
...
void			ft_send_next(t_send_server *o_player, t_client_thread *client,
					int nb);

/* -------------------------------------------------------------------------- */
/*                      FILE = srcs_bonus/math/math_2.c                       */
/* -------------------------------------------------------------------------- */
...
/* -------------------------------------------------------------------------- */
/*                 FILE = srcs_bonus/math/vector/operator2D.c                 */
/* -------------------------------------------------------------------------- */
...
/* -------------------------------------------------------------------------- */
/*                   FILE = srcs_bonus/math/vector/tools.c                    */
/* -------------------------------------------------------------------------- */
...
/* -------------------------------------------------------------------------- */
/*                 FILE = srcs_bonus/math/vector/operator2F.c                 */
/* -------------------------------------------------------------------------- */
...
/* -------------------------------------------------------------------------- */
/*                  FILE = srcs_bonus/math/vector/tools_2.c                   */
/* -------------------------------------------------------------------------- */
t_vector2F		velocity_get_point(t_vector2F start, t_vector2F velo,
					int time_ms);
t_vector3F		velocity_get_point3f(t_vector3F start, t_vector3F velo,
					int time_ms);
float			one_dist2f(t_vector2F a, t_vector2F b);
float			one_dist3f(t_vector3F a, t_vector3F b);

/* -------------------------------------------------------------------------- */
/*                       FILE = srcs_bonus/math/math.c                        */
/* -------------------------------------------------------------------------- */
...
/* -------------------------------------------------------------------------- */
/*                    FILE = srcs_bonus/parsing/parsing.c                     */
/* -------------------------------------------------------------------------- */
...
/* -------------------------------------------------------------------------- */
/*                     FILE = srcs_bonus/parsing/args_2.c                     */
/* -------------------------------------------------------------------------- */
...
/* -------------------------------------------------------------------------- */
/*                   FILE = srcs_bonus/parsing/parsing_2.c                    */
/* -------------------------------------------------------------------------- */
int				is_char_in_range(t_vector2D pos, char **map);
int				is_player(char c);
void			get_team_pos(char c, t_vector2D pos);
void			body_map(t_vector2D *pt, t_vector2D *it, char **map,
					int *longest);

/* -------------------------------------------------------------------------- */
/*                   FILE = srcs_bonus/parsing/parsing_3.c                    */
/* -------------------------------------------------------------------------- */
...
/* -------------------------------------------------------------------------- */
/*                   FILE = srcs_bonus/parsing/parsing_4.c                    */
/* -------------------------------------------------------------------------- */
...
/* -------------------------------------------------------------------------- */
/*                    FILE = srcs_bonus/menu/generate_2.c                     */
/* -------------------------------------------------------------------------- */
...
/* -------------------------------------------------------------------------- */
/*                    FILE = srcs_bonus/menu/mouse_hook.c                     */
/* -------------------------------------------------------------------------- */
...
/* -------------------------------------------------------------------------- */
/*                    FILE = srcs_bonus/menu/generate_3.c                     */
/* -------------------------------------------------------------------------- */
t_data			generate_image(char *path);
void			gen_bar(void);

/* -------------------------------------------------------------------------- */
/*                      FILE = srcs_bonus/menu/intro_2.c                      */
/* -------------------------------------------------------------------------- */
void			ft_open_intro_sprites(void);
void			ft_intro_sprite_to_image(int i1, int i2, t_vector2D v1,
					t_vector2D v2);
void			ft_init_youri(unsigned long *start, unsigned long *c,
					t_vector2D *pos);

/* -------------------------------------------------------------------------- */
/*                    FILE = srcs_bonus/menu/recv_utils.c                     */
/* -------------------------------------------------------------------------- */
int				ft_recv_players(t_send_server *o_player, int size);
int				ft_recv_one(int socket, t_send_client *player, int size);

/* -------------------------------------------------------------------------- */
/*                     FILE = srcs_bonus/menu/generate.c                      */
/* -------------------------------------------------------------------------- */
void			gen_alpha(void);
void			gen_bgs(void);
...
/* -------------------------------------------------------------------------- */
/*                     FILE = srcs_bonus/menu/render_2.c                      */
/* -------------------------------------------------------------------------- */
...
/* -------------------------------------------------------------------------- */
/*                      FILE = srcs_bonus/menu/utils_2.c                      */
/* -------------------------------------------------------------------------- */
t_data			ft_put_img_to_img_scale(t_data b, t_data l, t_vector2D p,
					t_vector2F s);
t_data			ft_put_image_to_image(t_data big, t_data lil, t_vector2D pos);
t_data			ft_put_image_to_image_create(t_data big, t_data lil,
					t_vector2D pos);
int				ft_chk_sprite(t_vector2D *it, t_vector2D pos, t_vector2D s,
					t_vector2D *r);

/* -------------------------------------------------------------------------- */
/*                      FILE = srcs_bonus/menu/utils_3.c                      */
/* -------------------------------------------------------------------------- */
void			restart_button(void);
int				ft_hitbox(t_vector2D hitbox[4], t_vector2D pos);
void			draw_pixel(t_data *big, t_data lil, t_vector2D it,
					t_vector2D rel_pos);
void			draw_pixel_create(t_data *big, t_data lil, t_vector2D it,
					t_vector2D r);
void			ft_init_rel2(t_vector2D *rel_pos, t_vector2F *it, t_vector2D p);

/* -------------------------------------------------------------------------- */
/*                       FILE = srcs_bonus/menu/intro.c                       */
/* -------------------------------------------------------------------------- */
...
/* -------------------------------------------------------------------------- */
/*                     FILE = srcs_bonus/menu/render_3.c                      */
/* -------------------------------------------------------------------------- */
...
/* -------------------------------------------------------------------------- */
/*                    FILE = srcs_bonus/menu/generate_4.c                     */
/* -------------------------------------------------------------------------- */
...
/* -------------------------------------------------------------------------- */
/*                       FILE = srcs_bonus/menu/utils.c                       */
/* -------------------------------------------------------------------------- */
t_data			ft_put_sprt_to_img(t_data l, t_vector2D p, t_vector2D sp,
					t_vector2D s);
...
/* -------------------------------------------------------------------------- */
/*                      FILE = srcs_bonus/menu/dragbar.c                      */
/* -------------------------------------------------------------------------- */
...
/* -------------------------------------------------------------------------- */
/*                    FILE = srcs_bonus/menu/menu_lobby.c                     */
/* -------------------------------------------------------------------------- */
...
/* -------------------------------------------------------------------------- */
/*                     FILE = srcs_bonus/menu/render_4.c                      */
/* -------------------------------------------------------------------------- */
...
/* -------------------------------------------------------------------------- */
/*                  FILE = srcs_bonus/drawing/draw_text_2.c                   */
/* -------------------------------------------------------------------------- */
int				is_allow_alpha(char c);
char			char_up(char c);
void			draw_text(char *text, t_vector2D pos, char color[4]);
t_data			ft_draw_char(t_data big, t_data lil, t_vector2D pos,
					char color[4]);
int				ft_chk_draw(t_vector2D *it, t_vector2D p, t_data lil,
					t_vector2D scale);

/* -------------------------------------------------------------------------- */
/*                  FILE = srcs_bonus/drawing/draw_player.c                   */
/* -------------------------------------------------------------------------- */
...
/* -------------------------------------------------------------------------- */
/*                 FILE = srcs_bonus/drawing/draw_player_2.c                  */
/* -------------------------------------------------------------------------- */
...
/* -------------------------------------------------------------------------- */
/*                    FILE = srcs_bonus/drawing/draw_map.c                    */
/* -------------------------------------------------------------------------- */
void			draw_player_map(void);
void			ft_draw_map(void);

/* -------------------------------------------------------------------------- */
/*                   FILE = srcs_bonus/drawing/draw_text.c                    */
/* -------------------------------------------------------------------------- */
void			ft_init_rel(t_vector2D *rel_pos, t_vector2D p);
t_data			ft_draw_char_scale(t_data lil, t_vector2D p, t_vector2D s,
					char c[4]);
void			draw_text_scale(char *text, t_vector2D pos, t_vector2D scale,
					char c[4]);
t_data			create_text_img(char *text, char color[4]);
void			draw_rectangle(t_vector2D a, t_vector2D size, char color[4]);

/* -------------------------------------------------------------------------- */
/*                   FILE = srcs_bonus/drawing/draw_map_2.c                   */
/* -------------------------------------------------------------------------- */
...
/* -------------------------------------------------------------------------- */
/*                   FILE = srcs_bonus/drawing/draw_map_3.c                   */
/* -------------------------------------------------------------------------- */
void			ft_find_wall_scale(void);
void			ft_give_id(void);

/* -------------------------------------------------------------------------- */
/*                        FILE = srcs_bonus/clock_2.c                         */
/* -------------------------------------------------------------------------- */
...
/* -------------------------------------------------------------------------- */
/*                  FILE = srcs_bonus/mlx_utils/mlx_utils.c                   */
/* -------------------------------------------------------------------------- */
...
/* -------------------------------------------------------------------------- */
/*                     FILE = srcs_bonus/mlx_utils/sky.c                      */
/* -------------------------------------------------------------------------- */
void			draw_sky(void);
...
/* -------------------------------------------------------------------------- */
/*                 FILE = srcs_bonus/mlx_utils/mlx_utils_3.c                  */
/* -------------------------------------------------------------------------- */
void			ft_init_mlx(void);

/* -------------------------------------------------------------------------- */
/*                 FILE = srcs_bonus/mlx_utils/mlx_utils_2.c                  */
/* -------------------------------------------------------------------------- */
...
/* -------------------------------------------------------------------------- */
/*                    FILE = srcs_bonus/mlx_utils/sky_2.c                     */
/* -------------------------------------------------------------------------- */
void			ft_next_while_draw_sky(t_vector2D pt);
void			ft_norme_while_draw_sky(int offst, int pitch,
					t_vector2D *pl_coord);
void			ft_norme_draw_sky(t_vector2D *pl_coord);

/* -------------------------------------------------------------------------- */
/*                    FILE = srcs_bonus/mlx_utils/render.c                    */
/* -------------------------------------------------------------------------- */
...
/* -------------------------------------------------------------------------- */
/*                     FILE = srcs_bonus/mlx_utils/hud.c                      */
/* -------------------------------------------------------------------------- */
void			hud_hit_and_touch(void);
void			hud(void);

/* -------------------------------------------------------------------------- */
/*                       FILE = srcs_bonus/dyn_array.c                        */
/* -------------------------------------------------------------------------- */
...
/* -------------------------------------------------------------------------- */
/*                  FILE = srcs_bonus/shoot/shoot_utils_2.c                   */
/* -------------------------------------------------------------------------- */
...
/* -------------------------------------------------------------------------- */
/*                        FILE = srcs_bonus/ft_itoa.c                         */
/* -------------------------------------------------------------------------- */
int				size_nb(int nb);
char			*ft_itoa(int n);

/* -------------------------------------------------------------------------- */
/*                          FILE = srcs_bonus/main.c                          */
/* -------------------------------------------------------------------------- */
